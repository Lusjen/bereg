	...
	<!-- begin price -->
	<div class="price">
		<div class="price__col price__block">
			<div class="price__img wow imageScale" data-wow-duration="5s"></div>
		</div>
			...
			<div class="price__info">
				<div class="price__top">
					...
					<ul class="breadcrumbs wow fadeInRight" data-wow-delay="0.2s">
						...
						<li class="breadcrumbs__item">
							<span class="">Ціни</span>
						</li>
					</ul>
				</div>
				<div class="price__bottom">
					<div class="price__bottom-in">
						<div class="price__title  wow fadeInDown" data-wow-delay="0.3s">
							<h2 class="title-md">Мінімальна ціна</h2>
						</div>
						<div class="price__box">
							...
							<div class="price__item">
								<span class="bold">17900</span>
							</div>
							<div class="price__item">
								2-кімнатні
							</div>
							<div class="price__item">
								<span class="bold">17700</span>
							</div>
							<div class="price__item">
								3-кімнатні
							</div>
						...
						<div class="price__title wow fadeInDown" data-wow-delay="0.3s">
							<h2 class="title-md">Видові квартири:</h2>
						</div>
						<div class="price__box">
							<div class="price__item">
								1-кімнатні
							...
							<div class="price__item">
								<span class="bold">19200</span>
							</div>
							<div class="price__item">
								2-кімнатні
							</div>
							<div class="price__item">
								<span class="bold">19000</span>
							</div>
							<!-- <div class="price__item">
								3-кімнатні
							</div>
						...
						<div class="price__link">
							<a href="#" class="link link-bg">
								...
								<p class="link__text link_white">Обрати квартиру</p>
							</a>
						</div>
					</div>
					<!-- begin price__decor -->
