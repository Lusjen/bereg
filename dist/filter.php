	...
	<div class="filter">
		<div class="filter__block">
			...
			<ul class="filter-results">		
				<li class="filter-item js-result__item" data-floor="6" data-rooms="1" data-area="66" data-larea="68">
					<a href="/dist/appartment.php" class="filter-item__link">
						<div class="filter-item__img">
							<img src="img/flat/1.png" alt="" title="">
						</div>
						<table class="filter-item__table">
							<tbody>
								...
								<tr>
									...
									<td class="table-result">66.44</td>
								</tr>
								<tr>
									<td class='table-title'>Житлова площа:</td>
									<td class="table-result">68.45</td>
								</tr>
							</tbody>
						</table>
				...
				<li class="filter-item js-result__item" data-floor="3" data-rooms="2" data-area="40" data-larea="35">
					<a href="/dist/appartment.php" class="filter-item__link">
						<div class="filter-item__img">
							<img src="img/flat/1.png" alt="" title="">
						</div>
						<table class="filter-item__table">
							<tbody>
								...
								<tr>
									<td class='table-title'>Загальна площа:</td>
									<td class="table-result">45.44</td>
								</tr>
								<tr>
									<td class='table-title'>Житлова площа:</td>
									<td class="table-result">40.44</td>
								</tr>
							</tbody>
						</table>
						<div class="filter-item__button">
				...
				<li class="filter-item js-result__item" data-floor="3" data-rooms="2" data-area="39" data-larea="20">
					<a href="/dist/appartment.php" class="filter-item__link">
						<div class="filter-item__img">
							<img src="img/flat/1.png" alt="" title="">
						</div>
						<table class="filter-item__table">
							<tbody>
								...
								<tr>
									<td class='table-title'>Загальна площа:</td>
									<td class="table-result">25.99</td>
								</tr>
								<tr>
									<td class='table-title'>Житлова площа:</td>
									<td class="table-result">20.99</td>
								</tr>
							</tbody>
						</table>
						<div class="filter-item__button">
				...
				<li class="filter-item js-result__item"  data-floor="3" data-rooms="3" data-area="70" data-larea="65">
					<a href="/dist/appartment.php" class="filter-item__link">
						<div class="filter-item__img">
							<img src="img/flat/1.png" alt="" title="">
						</div>
						<table class="filter-item__table">
							<tbody>
								...
								<tr>
									<td class='table-title'>Загальна площа:</td>
									<td class="table-result">70.88</td>
								</tr>
								<tr>
									<td class='table-title'>Житлова площа:</td>
									<td class="table-result">65.88</td>
								</tr>
							</tbody>
						</table>
						<div  class="filter-item__button">
			...
			<div class="filter__info">
				<div class="filter__top">
					...
					<ul class="breadcrumbs wow fadeInRight" data-wow-delay="0.2s">
						...
						<li class="breadcrumbs__item">
							<a href="/" class="breadcrumbs__link">Вибір поверху</a>
						</li>
						<li class="breadcrumbs__item">
							<span class="">Фільтр</span>
						</li>
					</ul>
				</div>
				<div class="filter__bottom">
					<div class="filter__bottom-in">
						<div class="option-block">
							...
							<div class="checkbox-item option__item checkboxes__rooms js_checkboxes__rooms">
								...
								<div class="range-item__checkbox">
							...
							<div class="range-item option__item">
								<div class="range-item__title">Загальна площа, м.кв</div>
								<div class="range-item__block">
									<input class="js_val_square_min slider__currentMin" type="number" min="30" value="30" max="100" id="square_min">
									<input class="js_val_square_max slider__currentMax" type="number" min="30" value="100" max="100" id="square_max">
								</div>
								<input type="hidden" class="range-init irs-hidden-input" id="val_square" value="30;100">
							</div>
							<!-- /.range-item -->
							...
							<div class="range-item option__item">
								...
								<div class="range-item__block">
									<input class="js_val_squareLiv_min slider__currentMin" type="number" min="15" value="15" max="100" id="squareLiv_min">
									<input class="js_val_squareLiv_max slider__currentMax" type="number" min="15" value="100" max="100" id="squareLiv_max">
								</div>
								<input type="hidden" class="range-init irs-hidden-input" id="val_squareLiv" value="15;100">
							</div>

							<!-- /.option__results -->
							<div class="option__item js-button_search">
								<a href="#" class="link link-bg js-popup-price">
									...
									<p class="link__text link_white">Фільтрувати</p>
								</a>
							</div>
