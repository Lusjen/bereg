	...
	<div class="compare">
		<div class="compare__top">
			...
			<ul class="breadcrumbs wow fadeInRight" data-wow-delay="0.2s">
				...
				<li class="breadcrumbs__item">
					<span class="">Порівняти квартири</span>
				</li>
			</ul>
		</div>
		<div class="compare__content">
			<div class="compare__img">
				<div class="compare-table">
					<div class="compare-table-head"><div class="compare-table-headline ">
						<h3 class="compare-table__title">
							<span>У порівнянні </span>
							<span>2 квартири</span>
						</h3>
						</div>
							<div class="compare-items-wrapper">
								<div class="compare-item-img">
									<img src="img/flat/1.png" alt="">
									<button type="button" class="compare-item__button-close button-close">
										<span></span>
										<span></span>
									</button>
								</div>
						...
						<div class="compare-table-body">
							<ul class="compare-table__info">
								<li>Поверх:</li>
								<li>Площа:</li>
								<li>Загальна площа:</li>
								<li>Житлова площа:</li>
								<li>Передпокій:</li>
								<li>Кухня-їдальня:</li>
								<li>Спальня</li>
			...
			<div class="compare__links">
				<div class="compare__link">
					<a href="filter.php" class="link-gradient">
