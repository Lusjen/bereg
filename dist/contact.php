	...
	<!-- begin contact -->
	<div class="contact">
		<div class="contact__col contact__block">
		...
		<div class="contact__col">
			<div class="contact__info">
				...
				<div class="contact__bottom">
					<div class="contact__bottom-in">
						<div class="contact__row">
							<div class="contact__title wow fadeInDown" data-wow-duration="0.3s">
								<h2 class="title-md">Адреса будівництва:</h2>
							</div>
							<ul class="contacts">
								<li class="contacts__item" onclick="filterMarkers($(this).attr('data-category'))" data-category="main"> 
									<!-- <a href="" class="contacts__link"> -->
										 <img src="img/contact/map-contact.svg" alt="">
										 <span>Дніпровська набережна, 17В</span> 
									<!-- </a> -->
								</li>
							</ul>
						</div>
						<div class="contact__row">
							<div class="contact__title wow fadeInDown"  data-wow-duration="0.7s">
								<h2 class="title-md">Відділ продажу:</h2>
							</div>
							<div class="contact__img-sale">
								<img src="img/contact/sale1.png" alt="">
							</div>	
							<ul class="contacts">
								<li class="contacts__item" onclick="filterMarkers($(this).attr('data-category'))" data-category="main"> 
									<!-- <a href="" class="contacts__link"> -->
										 <img src="img/contact/map-contact.svg" alt="">
										 <span> Київ, Дніпровська набережна, 17В</span> 
									<!-- </a> -->
								</li>
							<!-- </ul>
						</div>
						<div class="contact__row"> -->
							...
							<div class="contact__img-sale">
								<img src="img/contact/sale.png" alt="">
							</div> -->	
							<!-- <ul class="contacts"> -->
								<li class="contacts__item" onclick="filterMarkers($(this).attr('data-category'))" data-category="sale"> 
									<!-- <a href="" class="contacts__link"> -->
										 <img src="img/contact/map-contact.svg" alt="">
										 <span> Київ, Повітрофлотський проспект, 56</span> 
									<!-- </a> -->
								</li>
								<li class="contacts__item" onclick="filterMarkers($(this).attr('data-category'))" data-category="sale1">
									 <!-- <a href="" class="contacts__link">  -->
									 	<img src="img/contact/map-contact.svg" alt="">
									 	<span>Київ, Глибочицька, 13</span> 
									 <!-- </a> -->
								</li>
								<li class="contacts__item"> 
									<a href="tel:6556" class="contacts__link"> 
										<img src="img/contact/phone-contact.svg" alt=""> 
										<!-- <span >+380448282822</span> -->
										<span>6556</span>
									</a>
								</li>
								<!-- <li class="contacts__item">
									 <a href="mailto:info@beregdnipra.com.ua" class="contacts__link "> 
									 	<img src="img/contact/email.svg" alt="">
									 	<span>info@beregdnipra.com.ua</span>
									  </a>
								</li> -->
								<li class="contacts__item"> 
									<span class="contacts__link"> 
										<img src="img/contact/time.svg" alt="">
										<span>Пн-пт: 10.00 - 20.00 <br> Сб. 12.00 - 17.00<br> Нд. - вихідний</span>
									</span>
								</li>
							</ul>
						</div>
						<div class="contact__row">
							<div class="link link-contact js-btn-popup-contact">
								<div class="link__circle link__circle_blue">
							      <span class="icon">
							      	<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							      	<path d="M14.4 0H1.6C0.72 0 0 0.72 0 1.6V16L3.2 12.8H14.4C15.28 12.8 16 12.08 16 11.2V1.6C16 0.72 15.28 0 14.4 0Z" fill="white"/>
							      	</svg>
							      </span>
							    </div>
								<p class="link__text">Зворотній зв'язок</p>
							</div>
						</div>
						
					</div>
					<div class="contact__decor">
						<svg width="404" height="65" viewBox="0 0 404 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-decor-gray">
		...
		<div class="contact__link-map wow fadeInLeft" data-wow-delay="0.4s">
		...
		<div class="contact__link-gallery wow fadeInLeft" data-wow-delay="0.5s">
		...
		<div class="contact__link-flat wow fadeInLeft" data-wow-delay="0.2s">
		...
		<div class="contact__popup popup-contact">
			<!-- <div class="popup-contact__content js-contact-img"> -->
				<form class="mainForm" id="contact">
					<div class="mainForm__in">
						<div class="mainForm__title">
						<p class="text-bold">Зворотній зв'язок</p>
					</div>
		            ...
		            <div class="mainForm-wrap mainForm-wrap_brb">
		              <span class="mainForm__text mainForm__text_brb " data-defaultMessage="Повідомлення:" data-errorMessage="Заповніть повідомлення">Повідомлення:</span>
		              <textarea  rows="5" cols="45" name="message" class="mainForm__input"></textarea>
		            </div>
		            <!--  </mainForm-wrap> -->
					...
					<div class="popup-contact__btn-close js-close-popup-contact">
						<span></span>
						<span></span>
					</div>
		        </form>
