	...
	<div class="header__inner">
		<a href="index.php" class="header__logo">
			...
			<ul class="menu">
				<li class="menu__item">
					...
					<ul class="submenu">
						...
						<li class="submenu__item">
							<a href="#" class="submenu__link">Документи</a>
						</li>
						<li class="submenu__item">
			...
			<a href="tel:6556" class="tel">
				...
				<!-- <span class="tel__link col-white">+38 (044) <span class="bold">91-68-777</span></span> -->
				<span class="tel__link col-white"><span class="bold">6556</span></span>
			</a>
			<div class="lang col-white">
				<div class="lang__list">
					<div class="lang__item">
						<a href="#" class="lang__link col-white">uk</a>
					</div>
					<div class="lang__item">
						<a href="#" class="lang__link col-white">ru</a>
					</div>
					<div class="lang__item">
						<a href="#" class="lang__link col-white">en</a>
					</div>
				</div>
				<a href="#" class="lang__menu-link">
					<svg width="7" height="4" viewBox="0 0 7 4" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-white">
		...
		<ul class="menu-mob__list">
			<li class="menu-mob__item">
				...
				<ul class="sub-menu">
	              ...
	              <li  class="sub-menu__item">
	              	<a class="sub-menu__link" href="#">Документи</a>
	              </li>
	              <li  class="sub-menu__item">
	              	<a class="sub-menu__link" href="#">Характеристики</a>
	              </li>
	              <li  class="sub-menu__item">
	              	<a class="sub-menu__link" href="developer.php">Забудовник</a>
	              </li>
	              <li  class="sub-menu__item">
