...
// jQuery(document).ready(function($) {
	  ...
	  //     $('.menu__link').addClass('fadeInUp');
	  //     $('.menu__link').removeClass('fadeInTop')
	  // });
	  // $('.btn-close-menu').on('click', function() {
	  //     $('.menu-btn').removeClass('active')
	  //     $('.menu').removeClass("menu--open");
	  //     $('.menu').addClass("menu--close");
	  //     $('.menu__link').removeClass('fadeInUp');
	  //     $('.menu__link').addClass('fadeInTop')
	  // });

// });

	//add new 
	var scrollable = $(".js-wow-container");
	wow = new WOW({
	...
	scrollable.on('scroll.wow', function() {
	  ...
	  scrollable.find('.wow.animated').css({'animation-duration': '1s'})
	});
	...
	var mainForm = function () {
	    ...
	    function ajax_form(e) {
	      ...
	      if (!errors) {
	        $.ajax({
	            ...
	            data: str,
	            beforeSend: function () {
	              $(e).find('.sand-form__text').text('Відправлення...') // замена текста в кнопке при отправке
	            },
	            error: function () {
	              $(e).find('.sand-form__text').text('Помилка відправки!'); // замена текста в кнопке при отправке в случае
	            }
	          ...
	          .done(function (msg) {
	            ...
	            $(e).find('.sand-form__text').text('Надіслати')
	            /*ga('send', {
	              hitType: 'event',
  	...
  	telMask();
  	var loader = function () {
  	    $(".backdrop").delay(1000).fadeOut(500);
